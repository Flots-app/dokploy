...
export const DATABASE_ALERT_PRESETS: Record<DatabaseKind, AlertPreset[]> = {
	postgres: [
		...
		},
		{
			...
			forDuration: "5m",
			severity: "warning",
			name: "PostgreSQL connection usage is high",
		...
		},
		{
			...
			forDuration: "5m",
			severity: "warning",
			name: "PostgreSQL rollback ratio is high",
		...
		},
		{
			...
			forDuration: "10m",
			severity: "warning",
			name: "PostgreSQL cache hit ratio is low",
		...
		},
		{
			...
			forDuration: "5m",
			severity: "critical",
			name: "PostgreSQL replication is delayed",
	...
	redis: [
		...
		},
		{
			...
			forDuration: "5m",
			severity: "warning",
			name: "Redis memory usage is high",
		...
		},
		{
			...
			forDuration: "5m",
			severity: "warning",
			name: "Redis has blocked clients",
		...
		},
		{
			...
			forDuration: "10m",
			severity: "warning",
			name: "Redis cache hit ratio is low",
		...
		},
		{
			...
			forDuration: "5m",
			severity: "critical",
			name: "Redis replication is degraded",
